...
class DepartmentHeadUsersScreen extends StatefulWidget {
  const DepartmentHeadUsersScreen({super.key});

  @override
  State<DepartmentHeadUsersScreen> createState() => _DepartmentHeadUsersScreenState();
}

class _DepartmentHeadUsersScreenState extends State<DepartmentHeadUsersScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Row(
        ...
        children: [
          const DepartmentHeadSidebar(activeItem: "Users"),
          Expanded(
            child: Column(
              children: [
