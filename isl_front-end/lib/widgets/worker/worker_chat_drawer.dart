...
// ─────────────────────────────────────────────────────────────────────────────
// WORKER CHAT SIDEBAR (Drawer)
// Modeled on the reference screenshot's layout (New chat / Search chats /
// Recent), but intentionally WITHOUT Notebooks, Images, Videos, and
// Library — this app only ever needs chat sessions, so those sections are
// dropped entirely per product requirement.
//
// "Recent" is powered by GET /api/chat/sessions/, which is scoped to the
...
class WorkerChatDrawer extends StatefulWidget {
  ...
  /// Called when the user taps "New chat". The parent (WorkerChatScreen)
  ...
  /// Called when the user confirms "Logout" from the sidebar.
  ...
  @override
  State<WorkerChatDrawer> createState() => _WorkerChatDrawerState();
}

class _WorkerChatDrawerState extends State<WorkerChatDrawer> {
