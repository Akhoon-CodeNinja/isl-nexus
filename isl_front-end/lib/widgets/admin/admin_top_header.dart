...
/// Reusable top header for all Admin Portal screens. Shows the page
/// title/subtitle on the left, and the signed-in user's real name +
/// designation on the right.
class AdminTopHeader extends StatefulWidget {
  final String title;
  ...
  @override
  State<AdminTopHeader> createState() => _AdminTopHeaderState();
}

class _AdminTopHeaderState extends State<AdminTopHeader> {
