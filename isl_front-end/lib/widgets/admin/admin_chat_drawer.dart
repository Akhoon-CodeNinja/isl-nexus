...
//
// _bg intentionally matches AdminSidebar's background color (0xFF0F294D)
// so the drawer reads as part of the same admin shell rather than a
// worker-styled overlay.
// ─────────────────────────────────────────────────────────────────────────────
/// Shared widget (Admin) — slide-out drawer listing AI Assistant chat sessions for quick switching.
class AdminChatDrawer extends StatefulWidget {
  ...
  /// Called when the user taps "New chat". The parent (AdminChatScreen)
  ...
  @override
  State<AdminChatDrawer> createState() => _AdminChatDrawerState();
}

class _AdminChatDrawerState extends State<AdminChatDrawer> {
